...
var currentAnchors = $('#clearFilterButton').find("a"); 
currentAnchors.remove(); 
$('.activeFiltersContainer').after('<a href="portfolioproductlinegate2?products.page=1" class="fonticon fonticon-trash reset-btn" title="Remove all filters">b</a>');                                 
